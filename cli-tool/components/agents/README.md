...
- **Original Agents** by Claude Code Templates team (3 agents)
- **wshobson/agents Collection** by [wshobson](https://github.com/wshobson/agents) - Licensed under MIT License (48 agents)

All agents maintain their original licensing and attribution. See [LICENSE-wshobson-agents](LICENSE-wshobson-agents) for the MIT license terms.
